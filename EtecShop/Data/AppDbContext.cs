...
public class AppDbContext : IdentityDbContext
{
    ...
    List<Produto> produtos = new()
    {
        new Produto(){
            ...
            Descricao = "A Biblioteca da Meia-Noite é um romance incrível que fala dos infinitos rumos que a vida pode tomar e da busca incessante pelo rumo certo.Aos 35anos, Nora Seed é uma mulher cheia de talentos e poucas conquistas.",
            Preco = 34.99M,
            Estoque = 10,
            CategoriaId = 1,
        ...
        new Produto(){
            ...
            Descricao = "Notebook 2 Em 1 Positivo Duo C4128b-3 Intel Celeron Dual Core Windows11 Home 11,6' - Cinza Escuro - Inclui Microsoft 365* Notebook 2 em 1 Positivo Duo C4128B-3 Intel Celeron Dual Core Windows11 Home 11,6' - Cinza Escuro", Preco = 1439.10M,
            Estoque = 17,
            CategoriaId = 3,
